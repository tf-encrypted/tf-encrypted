...
class TestMatMul(unittest.TestCase):
    ...
    #
    #             out_pond = sess.run(out.reveal(), tag='reveal')
    #
    #     # reset graph
    #     tf.reset_default_graph()
    #
    ...
    def test_big_middle_matmul(self) -> None:
        ...
        with tfe.protocol.Pond() as prot:
            ...
            out = prot.mask(input_input)
            out2 = prot.mask(filter_filter)
            ...
            with tfe.Session() as sess:
                ...
                out_pond = sess.run(out.a.backing[0])
                out2_pond = sess.run(out2.a.backing[0])
