...
def floormod(converter: Converter, node: Any, inputs: List[str]) -> Any:
    ...
    WARNING = (
        "This model is using a FloorMod operation which is currenlty a public operation. "
        "FloorMod is often a sub ops generated by tf.required_space_to_batch_paddings "
        "operation which is part of a Conv1D layer")
    ...
    out = converter.protocol.define_private_input(converter.model_provider, inputter_fn)
    return(out)
