...
class LogisticRegression(PrivateModel):
    def __init__(self):
        ...
        self.model.add(tfe.keras.layers.Dense(1, activation=None, lazy_normalization=True))
        ...
        loss = tfe.keras.losses.BinaryCrossentropy(from_logits=True, lazy_normalization=True)
