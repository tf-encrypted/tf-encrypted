...
if len(sys.argv) > 1:
    ...
    with tfe.protocol.Pond(*config.get_players('server0, server1, crypto_producer')) as prot:
        ...
        x = prot.define_private_input('prediction_client', provide_input_prediction)

        print("Define Block 1")
        # Block 1
        conv11 = Conv2D(input_shape, conv11_fshape, 1, "SAME")
        initial_w_conv11 = prot.define_private_input('weights_provider', provide_input_conv11weights)
        ...
        initial_w_conv12 = prot.define_private_input('weights_provider', provide_input_conv12weights)
        ...
        initial_w_pool1 = prot.define_private_input('weights_provider', provide_input_pool1weights)
        ...
        initial_w_conv21 = prot.define_private_input('weights_provider', provide_input_conv21weights)
        ...
        initial_w_conv22 = prot.define_private_input('weights_provider', provide_input_conv22weights)
        ...
        initial_w_pool2 = prot.define_private_input('weights_provider', provide_input_pool2weights)
        ...
        initial_w_conv31 = prot.define_private_input('weights_provider', provide_input_conv31weights)
        ...
        initial_w_conv32 = prot.define_private_input('weights_provider', provide_input_conv32weights)
        ...
        initial_w_conv33 = prot.define_private_input('weights_provider', provide_input_conv33weights)
        ...
        initial_w_pool3 = prot.define_private_input('weights_provider', provide_input_pool3weights)
        ...
        initial_w_conv41 = prot.define_private_input('weights_provider', provide_input_conv41weights)
        ...
        initial_w_conv42 = prot.define_private_input('weights_provider', provide_input_conv42weights)
        ...
        initial_w_conv43 = prot.define_private_input('weights_provider', provide_input_conv43weights)
        ...
        initial_w_pool4 = prot.define_private_input('weights_provider', provide_input_pool4weights)
        ...
        initial_w_conv51 = prot.define_private_input('weights_provider', provide_input_conv51weights)
        ...
        initial_w_conv52 = prot.define_private_input('weights_provider', provide_input_conv52weights)
        ...
        initial_w_conv53 = prot.define_private_input('weights_provider', provide_input_conv53weights)
        ...
        initial_w_pool5 = prot.define_private_input('weights_provider', provide_input_pool5weights)
