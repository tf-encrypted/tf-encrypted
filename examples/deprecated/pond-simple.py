...
a = prot.Variable(np.array([1., 2., 3., 4.]).reshape(2, 2))
b = prot.Variable(np.array([1., 2., 3., 4.]).reshape(2, 2))
c = prot.Variable(np.array([1., 2., 3., 4.]).reshape(2, 2))

x = (a * b)
y = (a * c)
z = x + y

w = prot.Variable(np.zeros((2, 2)))
