...
(taskset -c 12,13,14,15 python -m tf_encrypted.player weights-provider --config ${ABS_DIRECTORY}/config.json > log_weights_provider.txt 2>&1 &)
sleep 1
...
(time taskset -c 20,21,22,23 python ${ABS_DIRECTORY}/convert.py $* > log_master.txt 2>&1 &)
