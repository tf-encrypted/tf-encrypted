...
class ModelTrainer():
  ...
  def build_training_graph(self, training_data) -> List[tf.Tensor]:
    ...
    model.add(keras.layers.Conv2D(self.HIDDEN_C1,(self.KERNEL,self.KERNEL),
...
if __name__ == '__main__':
  ...
  with tfe.protocol.SecureNN():
    ...
    model.add(tfe.keras.layers.Conv2D(ModelTrainer.HIDDEN_C1,(ModelTrainer.KERNEL,ModelTrainer.KERNEL),
    ...
    model.add(tfe.keras.layers.Conv2D(ModelTrainer.HIDDEN_C2,(ModelTrainer.KERNEL,ModelTrainer.KERNEL)))
    model.add(tfe.keras.layers.Activation('relu'))
    model.add(tfe.keras.layers.AveragePooling2D())
