...
kill -9 `ps -ef | grep ${ABS_DIRECTORY}/horizontal-training.py | grep -v grep | awk '{print $2}'`
...
echo "Run horizontally splited data training example..."
(time python ${ABS_DIRECTORY}/horizontal-training.py $* > log_master.txt 2>&1 &)
